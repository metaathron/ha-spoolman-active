...
that sets that spool active via the hub's webhook. The QR content never
changes for a given spool + webhook_id + base_url, so it is rendered once
at entity creation and cached - no polling.
"""
...
from .spoolman_registry import spool_id_from_device
from .webhook_hub import spool_qr_url
